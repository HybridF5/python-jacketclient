...
import jacketclient.exceptions
...
class ServiceCatalog(object):
    ...
    def url_for(self, attr=None, filter_value=None,
        ...
        if 'endpoints' in self.catalog:
            ...
            for endpoint in self.catalog['endpoints']:
                if not filter_value or endpoint[attr] == filter_value:
                    # Ignore 1.0 jacket endpoints
                    if endpoint.get("type") == 'jacket' and \
                            endpoint.get('versionId') in (None, '1.1', '2'):
                        matching_endpoints.append(endpoint)
            if not matching_endpoints:
                raise jacketclient.exceptions.EndpointNotFound()
        ...
        for service in catalog:
            ...
            if (service_name and service_type == 'jacket' and
            ...
            for endpoint in endpoints:
                # Ignore 1.0 jacket endpoints
                if (service.get("type") == 'jacket' and
        ...
        if not matching_endpoints:
            ...
            raise jacketclient.exceptions.AmbiguousEndpoints(
