...
from jacketclient.tests.functional import base


class TestAuthentication(base.ClientTestBase):
    def jacket(self, action, identity_api_version):
        ...
        return tempest.lib.cli.base.execute(
            "jacket", action, flags, cli_dir=self.cli_clients.cli_dir)
    ...
    def test_auth_via_keystone_v2(self):
        ...
        self.jacket("list", identity_api_version="2.0")
    ...
    def test_auth_via_keystone_v3(self):
        ...
        self.jacket("list", identity_api_version="3")
